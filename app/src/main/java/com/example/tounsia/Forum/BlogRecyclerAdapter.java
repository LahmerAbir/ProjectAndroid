package com.example.tounsia.Forum;
...
import com.example.tounsia.Forum.View_Controller.CommentsActvity;
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, int i) {
        ...
        viewHolder.blogCommentBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent commentIntent = new Intent(context, CommentsActvity.class);

...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        numeroReg=findViewById(R.id.regPhoneNo);
                        ...
                        mAuth.createUserWithEmailAndPassword(email, pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()) {
                                    ...
                                    String numero = numeroReg.getText().toString();
                                    String email = regemailText.getText().toString();

                                    Map newPost = new HashMap();
                                    newPost.put("username", username);
                                    newPost.put("numero", numero);
                                    ...
                                    Intent setUpIntent = new Intent(SignUpActivity.this, SignInActivity.class);

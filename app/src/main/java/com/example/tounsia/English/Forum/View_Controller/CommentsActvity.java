...
import com.example.tounsia.English.Forum.Comments;
import com.example.tounsia.English.Forum.CommentsRecyclerAdapter;
...
public class CommentsActvity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comments_actvity2);
        ...
        firebaseFirestore.collection("Posts/" + blog_post_id + "/Comments")
                .addSnapshotListener(CommentsActvity.this, new EventListener<QuerySnapshot>() {
                    @Override
                ...
                firebaseFirestore.collection("Posts/" + blog_post_id + "/Comments").add(commentsMap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentReference> task) {
                        ...
                        if(!task.isSuccessful()){
                            ...
                            Toast.makeText(CommentsActvity.this, "Error Posting Comment : " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();

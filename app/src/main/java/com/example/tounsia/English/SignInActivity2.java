...
public class SignInActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(loginEmail) && !TextUtils.isEmpty(loginPass)) {
                    ...
                    mAuth.signInWithEmailAndPassword(loginEmail, loginPass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            //If the task is not sucessful then give a toast with the error message provided by the task
                                ...
                                Toast.makeText(SignInActivity2.this,
                    ...
                    Toast.makeText(SignInActivity2.this, "Email or Password can't be empty", Toast.LENGTH_SHORT).show();
        ...
        loginRegBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent regIntent = new Intent(SignInActivity2.this, SignUpActivity2.class);
                //Started the Intent
    ...
    protected void onStart() {
        ...
        if (currentUser != null) {
            Toast.makeText(SignInActivity2.this, "Welcome", Toast.LENGTH_SHORT).show();
    ...
    private void sendToMain() {
        ...
        Intent mainIntent = new Intent(SignInActivity2.this, HomeActivity2.class);
        //Starting the mainIntentSi
